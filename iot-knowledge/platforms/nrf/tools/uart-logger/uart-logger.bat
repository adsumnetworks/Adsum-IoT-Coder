@echo off
REM UART Logger Wrapper Script (Windows)
REM Provides a consistent interface for the UART logging tool
...
if not exist "%PYTHON_SCRIPT%" (
    echo ERROR: nrf_uart_logger.py not found at %PYTHON_SCRIPT%
    exit /b 1
)
