...
# ESP Platform Rule: Bit Loading (rules/bit-loading.md)
...
defined once in the universal `rules/bit-loading.md`. This table is the ESP-specific instance of it.)*
...
4. **Inside debug-loop, it says load `actions/build.md` via MANDATORY BIT LOAD** → obey the directive.
