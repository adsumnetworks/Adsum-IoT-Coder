...
export const RELEASE_NOTES = {
	...
	card: {
		lines: [
			{
				head: "Home",
				body: "opens on your folder, your boards and your toolchains, then ranks the runs worth starting. Typing is the new session; the sessions menu holds the old ones.",
			},
			{
				head: "Account",
