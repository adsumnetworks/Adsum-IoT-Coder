...
const STORIES = [
	...
	["views-chat--entry-cellular-unlocked", "05-registered-first-paint"],
	["views-chat--entry-registered-settled", "06-registered-settled"],
	["adsum-registered--chip", "05a-account-chip"],
	["adsum-registered--unlocked", "05b-unlocked-card"],
	["adsum-registered--demo-hex", "05c-demo-hex"],
	["adsum-registered--demo-hex-flashing", "05d-demo-hex-flashing"],
	["adsum-requestaccess--form", "06-request-form"],
	["adsum-requestaccess--locked-row", "07-locked-row"],
	["adsum-requestaccess--account-signed-in", "08a-account-signed-in"],
	["adsum-requestaccess--account-signed-out", "08b-account-signed-out"],
