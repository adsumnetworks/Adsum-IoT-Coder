...
export const STEP_CONFIG = {
	0: {
		title: "How will you use Adsum IoT Coder?",
		description: "Select an option below to get started.",
		buttons: [
			{ text: "Continue", action: "next", variant: "default" },
			// Login button removed as per user request to remove account flow
		],
	},
	[NEW_USER_TYPE.FREE]: {
...
export const USER_TYPE_SELECTIONS: UserTypeSelection[] = [
	{ title: "Bring my own API key", description: "Use Adsum IoT Coder with your provider of choice", type: NEW_USER_TYPE.BYOK },
]
