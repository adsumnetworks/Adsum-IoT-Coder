			...
			<div>
				...
				<p
					...
					<span style={{ color: "var(--vscode-errorForeground)" }}>
						...
						multi-step tool use. Models vary a lot at that — if tool calls come back malformed, the model picker is
						one click away and switching keeps your conversation.)
					</span>
				</p>
			</div>
